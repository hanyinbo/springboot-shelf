...
////        UserDetails userDTO = (ManageUserDetails)authentication.getPrincipal();
//        // 获得请求IP
////        String ip = AccessAddressUtils.getIpAddress(request);
////        userDTO.setIp(ip);
//        try{
//            String token = jwtTokenUtils.createToken(loginName);
//            // 保存Token信息到Redis中
//            JwtTokenUtils.setTokenInfo(token, loginName);
//            // 返回创建成功的token
